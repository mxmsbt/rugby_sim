...
from rugby_core.env import controller_base
from rugby_core.env import rugby_action_set
from rugby_core.env import event_queue


KEY_TO_ACTIONS = {
    pygame.K_s: [rugby_action_set.action_short_pass,
                 rugby_action_set.action_pressure],
    pygame.K_d: [rugby_action_set.action_shot,
                 rugby_action_set.action_team_pressure],
    pygame.K_a: [rugby_action_set.action_high_pass,
                 rugby_action_set.action_sliding],
    pygame.K_w: [rugby_action_set.action_long_pass,
                 rugby_action_set.action_keeper_rush],
    pygame.K_q: [rugby_action_set.action_switch],
    pygame.K_c: [rugby_action_set.action_dribble],
    pygame.K_e: [rugby_action_set.action_sprint],
}
