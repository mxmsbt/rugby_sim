...
BUTTON_TO_ACTIONS = {
    0: [rugby_action_set.action_short_pass,
        rugby_action_set.action_pressure],
    1: [rugby_action_set.action_shot,
        rugby_action_set.action_team_pressure],
    2: [rugby_action_set.action_high_pass,
        rugby_action_set.action_sliding],
    3: [rugby_action_set.action_long_pass,
        rugby_action_set.action_keeper_rush],
    4: [rugby_action_set.action_switch],
    5: [rugby_action_set.action_dribble],
}
  ...
  def take_action(self, observations):
    ...
    for event in event_queue.get('gamepad', self._index):
      ...
      if (event.type == pygame.JOYAXISMOTION and event.axis == 5 and
          event.value > 0):
        active_buttons[rugby_action_set.action_sprint] = 1
