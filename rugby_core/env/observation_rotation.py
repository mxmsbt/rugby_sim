...
def rotate_sticky_actions(sticky_actions_state, config):
  ...
  """
  sticky_actions = rugby_action_set.get_sticky_actions(config)
...
def flip_single_action(action, config):
  ...
  action = rugby_action_set.named_action_from_action_set(
      rugby_action_set.get_action_set(config), action)
  if action == rugby_action_set.action_left:
    return rugby_action_set.action_right
  if action == rugby_action_set.action_top_left:
    return rugby_action_set.action_bottom_right
  if action == rugby_action_set.action_top:
    return rugby_action_set.action_bottom
  if action == rugby_action_set.action_top_right:
    return rugby_action_set.action_bottom_left
  if action == rugby_action_set.action_right:
    return rugby_action_set.action_left
  if action == rugby_action_set.action_bottom_right:
    return rugby_action_set.action_top_left
  if action == rugby_action_set.action_bottom:
    return rugby_action_set.action_top
  if action == rugby_action_set.action_bottom_left:
    return rugby_action_set.action_top_right
  return action
