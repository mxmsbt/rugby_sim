...
from rugby_core.env import constants as const
from rugby_core.env import rugby_action_set
from rugby_core.scenarios import e_PlayerRole_GK
import numpy as np
  ...
  def add_step(self, o):
    ...
    if self._video_writer:
      ...
      if self._config['display_game_stats']:
        ...
        sticky_actions = rugby_action_set.get_sticky_actions(self._config)
        ...
        if 'logits' in o._trace['debug']:
          ...
          action_set = rugby_action_set.get_action_set(self._config)
