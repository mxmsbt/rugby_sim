...
from rugby_core.env import rugby_env_core
from rugby_core.env import observation_rotation
import numpy as np
...
class FootballEnv(gym.Env):
  ...
  def __init__(self, config):
    ...
    self._env = rugby_env_core.FootballEnvCore(self._config)
    self._num_actions = len(rugby_action_set.get_action_set(self._config))
    ...
    for definition in definitions:
      ...
      try:
        player_factory = importlib.import_module(
            'rugby_core.env.players.{}'.format(name))
