...
from rugby_core import _gym_compat as gym
from rugby_core.env import rugby_action_set
from rugby_core.eval_server import config
from rugby_core.eval_server import utils
from rugby_core.eval_server.proto import game_server_pb2
from rugby_core.eval_server.proto import game_server_pb2_grpc
from rugby_core.eval_server.proto import master_pb2
from rugby_core.eval_server.proto import master_pb2_grpc
import grpc
import numpy as np
...
class RemoteFootballEnv(gym.Env):
  ...
  def __init__(self, username, token, model_name='', track='default',
    ...
    self._num_actions = len(rugby_action_set.action_set_dict['default'])
    self._track = track
