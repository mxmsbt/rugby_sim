...
"""Runs rugby_env on OpenAI's ppo2."""
...
import rugby_core.env as rugby_env
...
def create_single_rugby_env(iprocess):
  """Creates gfootball environment."""
  env = rugby_env.create_environment(
...
def train(_):
  ...
  vec_env = SubprocVecEnv([
      (lambda _i=i: create_single_rugby_env(_i))
